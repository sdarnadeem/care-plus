...
const DashboardMain = () => {
  ...
  return (
    <div className="main-contentt">
      <div className="col-md-10 bg-lg shadow mt-3 m-2 " style={{ width: "95%" }}>
        <div className="row ">
          {
            img.map((data, index) => {
              return (
                  ...
                  <div className="card l-bg-cherry">
                    <div className="card-statistic-3 p-4">
                      ...
                      <div className="mb-4 d-flex justify-content-between">
                        ...
                        <i><img src={data.img} className="imgdas" /></i>
                      </div>
                      <div className="row align-items-center mb-2 d-flex">
                        <div className="col-8">
                          <h2 className="d-flex align-items-center mb-0">{data.amt}</h2>
                        </div>
